...
const (
	defaultManagementReleaseURL  = "https://api.github.com/repos/hezhaoqian1/Cli-Proxy-API-Management-Center/releases/latest"
	defaultManagementFallbackURL = "https://github.com/hezhaoqian1/Cli-Proxy-API-Management-Center/releases/latest/download/management.html"
